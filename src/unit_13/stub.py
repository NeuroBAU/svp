...
from src.unit_7.stub import get_ledger_path, read_ledger
...
def _prepare_setup_agent(
    ...
    # Load profile schema
    from src.unit_3.stub import DEFAULT_PROFILE
    ...
    from src.unit_3.stub import VALID_ARCHETYPES
...
def _prepare_stakeholder_dialog(
    ...
    if state is not None and _requires_statistical_analysis(state):
        from src.unit_20.stub import STAKEHOLDER_DIALOG_STATISTICAL_PRIMER
...
def _prepare_blueprint_author(
    ...
    if state is not None and _requires_statistical_analysis(state):
        from src.unit_20.stub import BLUEPRINT_AUTHOR_STATISTICAL_PRIMER
...
def _prepare_test_agent(
    ...
    if state is not None and _requires_statistical_analysis(state):
        from src.unit_20.stub import TEST_AGENT_STATISTICAL_PRIMER
