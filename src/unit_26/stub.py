...
Exports ORCHESTRATION_SKILL, a complete markdown skill string following the
Claude Code skill schema. Contains the full SVP orchestration protocol
including the six-step action cycle, per-stage oversight checklists,
behavioral invariants, and operational guidance.
"""
