...
Never use pytest.raises(NotImplementedError) as a behavioral test. Stubs raise NotImplementedError by design; testing for that exception verifies the stub, not the contract. Every test must verify actual behavioral contracts from the blueprint.
