...
IMPORT_REWRITE_MAP = {
    ...
    "src.unit_18.stub": "setup_agent",
    "src.unit_19.stub": "blueprint_checker",
    "src.unit_20.stub": "construction_agents",
    "src.unit_21.stub": "diagnostic_agents",
    "src.unit_22.stub": "support_agents",
    "src.unit_23.stub": "generate_assembly_map",
    "src.unit_24.stub": "debug_agents",
    "src.unit_25.stub": "slash_commands",
    "src.unit_26.stub": "orchestration_skill",
    "src.unit_27.stub": "project_templates",
...
STUB_TO_SCRIPT = {
    ...
    "src/unit_17/stub.py": "scripts/hooks.py",
    "src/unit_18/stub.py": "scripts/setup_agent.py",
    "src/unit_19/stub.py": "scripts/blueprint_checker.py",
    "src/unit_20/stub.py": "scripts/construction_agents.py",
    "src/unit_21/stub.py": "scripts/diagnostic_agents.py",
    "src/unit_22/stub.py": "scripts/support_agents.py",
    "src/unit_23/stub.py": "scripts/generate_assembly_map.py",
    "src/unit_24/stub.py": "scripts/debug_agents.py",
    "src/unit_25/stub.py": "scripts/slash_commands.py",
    "src/unit_26/stub.py": "scripts/orchestration_skill.py",
    "src/unit_27/stub.py": "scripts/project_templates.py",
