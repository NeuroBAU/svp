...
class DebugSession:
    ...
    triage_refinement_count: int  # Tracks triage re-invocations (default limit 2)
    repair_retry_count: int  # Tracks repair re-invocations (default limit 3)
    created_at: str
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DebugSession":
        return cls(
            ...
            triage_refinement_count=data.get("triage_refinement_count", 0),
            repair_retry_count=data.get("repair_retry_count", 0),
