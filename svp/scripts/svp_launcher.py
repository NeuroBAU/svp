...
(link to lessons-learned pattern number) / Detection (name regression \
test functions).
...
`svp/skills/`, Unit 23 → `svp/agents/`, `svp/hooks/`), manually update \
the corresponding `.md` files in the repo svp/ directory.
...
anything whose described behavior is changing.
   - This is MANDATORY first step (S3-169): code must not get ahead of spec.
