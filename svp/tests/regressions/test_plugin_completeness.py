...
# Repo locations
PASS2_REPO = Path(__file__).resolve().parents[2].parent / "svp2.2-pass2-repo"
PASS1_REPO = Path(__file__).resolve().parents[2].parent / "svp2.2-repo"
WORKSPACE = Path(__file__).resolve().parents[2]

REPOS = [PASS2_REPO, PASS1_REPO]
