...
the patterns that produced 73 bugs across five build
...
- **Regression tests** (`tests/regressions/`): Carry-forward tests for all 73 catalogued bugs. Each file targets a specific bug scenario.
