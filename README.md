...
delivered repository) catalogs 58 bugs discovered across
...
- **Regression tests** (`tests/regressions/`): Carry-forward tests for all 53 catalogued bugs. Each file targets a specific bug scenario.
