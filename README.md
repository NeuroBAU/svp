...
delivered repository) catalogs 64 bugs discovered across
...
the patterns that produced 64 bugs across five build
...
- **Regression tests** (`tests/regressions/`): Carry-forward tests for all 62 catalogued bugs. Each file targets a specific bug scenario.
