...
- The same content MUST appear at workspace `CLAUDE.md` (parallel near-duplicate, by design — the two files diverge at file-path level; tests verify the synchronized content lives in both).
