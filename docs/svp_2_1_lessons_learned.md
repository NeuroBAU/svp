...
## Part 1: Unified Bug Catalog (Bugs 1-74)
...
**Instances:** Bugs 1, 3, 5, 6, 7, 8, 16, 17, 18, 19, 21, 22, 23, 25, 26, 27, 28, 29, 31, 33, 37, 38, 40, 41, 43, 44, 47, 48, 49, 51, 52, 53, 54, 55, 56, 58, 64, 65, 66, 67, 68, 69 (42 of 74 bugs).
...
### P7 — Spec Completeness
**Instances:** Bugs 15, 28, 30, 32, 34, 36, 38, 39, 41, 43, 48, 49, 50, 62, 65 (15 of 74 bugs).
...
1. **Every cross-unit interface needs a structural test.** P1 is the most common pattern (42 of 74 bugs). AST-based tests are the primary defense.
