...
class TestGateVocabulary:
    ...
    def test_gate_vocabulary_has_34_gates(self):
        """GATE_VOCABULARY must contain exactly 38 gate entries (31 baseline
    ...
    def test_all_expected_gate_ids_present(self):
        """All 38 expected gate IDs are present in GATE_VOCABULARY (31
        ...
        gate_4_4_integration_tests_blocked per Bug S3-208 cycle K-6)."""
        expected_gates = {
