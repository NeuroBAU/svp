...
class TestGateResponseCallsAdvanceStage:
    ...
    @patch("src.unit_14.stub.advance_stage")
...
class TestGateResponseCallsRestartFromStage:
    ...
    @patch("src.unit_14.stub.restart_from_stage")
...
class TestGateResponseCallsRollbackToUnit:
    ...
    @patch("src.unit_14.stub.rollback_to_unit")
    @patch("src.unit_14.stub.update_debug_phase")
    @patch("src.unit_14.stub.set_debug_classification")
...
class TestGateResponseCallsDebugTransitions:
    ...
    @patch("src.unit_14.stub.authorize_debug_session")
    ...
    @patch("src.unit_14.stub.abandon_debug_session")
    ...
    @patch("src.unit_14.stub.complete_debug_session")
    ...
    @patch("src.unit_14.stub.enter_debug_session")
...
class TestAgentStatusCallsTransitions:
    ...
    @patch("src.unit_14.stub.increment_alignment_iteration")
    ...
    @patch("src.unit_14.stub.enter_redo_profile_revision")
...
class TestCommandStatusCallsTransitions:
    ...
    @patch("src.unit_14.stub.increment_red_run_retries")
    ...
    @patch("src.unit_14.stub.advance_fix_ladder")
    ...
    @patch("src.unit_14.stub.complete_unit")
