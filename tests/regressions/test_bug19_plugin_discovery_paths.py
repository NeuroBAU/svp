...
_validate_plugin_dir (renamed from _is_svp_plugin_dir in SVP 2.2) must
read plugin.json and check name == 'svp', not just check that the
directory exists.
"""
